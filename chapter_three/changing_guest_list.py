...
print(f"Hi, {guest_list[0].title()}, would you like to come to dinner with me?")
print(f"Hi, {guest_list[1].title()}, I had to send out another set of invitations, but would you still like to come to dinner with me?")
print(f"Hi, {guest_list[2].title()}, I had to send out another set of invitations, but would you still like to come to dinner with me?")
